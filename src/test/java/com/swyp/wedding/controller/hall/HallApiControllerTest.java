...
@WebMvcTest(value = HallApiController.class,
...
public class HallApiControllerTest {
    ...
    void setUp() {
        ...
        testResponse2.setLightType(LightType.DIM);
    ...
    @Test
    @DisplayName("GET /api/hall - 홀 리스트 조회 성공")
    void getHalls_Success() throws Exception {
        // given
        ...
        mockMvc.perform(get("/api/hall"))
                ...
                .andExpect(jsonPath("$[0].name").value("루미에르 홀"))
                .andExpect(jsonPath("$[0].hallType").value("SINGLE"))
                .andExpect(jsonPath("$[0].capacityMin").value(80))
                .andExpect(jsonPath("$[0].capacityMax").value(220))
                .andExpect(jsonPath("$[0].floorNo").value(2))
                .andExpect(jsonPath("$[0].lightType").value("BRIGHT"))
                .andExpect(jsonPath("$[1].id").value(2))
                .andExpect(jsonPath("$[1].name").value("벨라루체 홀"))
                .andExpect(jsonPath("$[1].hallType").value("COMPLEX"));
    }

    @Test
    @DisplayName("GET /api/hall - 빈 리스트 조회")
    void getHalls_EmptyList() throws Exception {
        // given
    ...
    @Test
    @DisplayName("GET /api/hall/{id} - 홀 상세정보 조회")
    void getHallInfo_Success() throws Exception {
        // given
        given(hallService.getHallInfo(anyLong())).willReturn(testResponse1);
        ...
        mockMvc.perform(get("/api/hall/{id}", 1L))
                ...
                .andExpect(jsonPath("$.name").value("루미에르 홀"))
                .andExpect(jsonPath("$.hallType").value("SINGLE"))
                .andExpect(jsonPath("$.capacityMin").value(80))
                .andExpect(jsonPath("$.capacityMax").value(220))
                .andExpect(jsonPath("$.floorNo").value(2))
                .andExpect(jsonPath("$.lightType").value("BRIGHT"))
                .andExpect(jsonPath("$.stage").value(true))
                .andExpect(jsonPath("$.ledWall").value(false));
    }

    @Test
    @DisplayName("POST /api/hall - 홀 저장 성공")
    void saveHall_Success() throws Exception {
        // given
        given(hallService.saveHall(any(HallRequest.class))).willReturn(true);
    ...
    @Test
    @DisplayName("POST /api/hall - 홀 저장 실패")
    void saveHall_Failure() throws Exception {
        // given
        given(hallService.saveHall(any(HallRequest.class))).willReturn(false);
    ...
    @Test
    @DisplayName("PUT /api/hall/{id} - 홀 수정 성공")
    void updateHall_Success() throws Exception {
        // given
        testRequest.setId(1L);
        given(hallService.updateHall(any(HallRequest.class))).willReturn(true);
    ...
    @Test
    @DisplayName("PUT /api/hall/{id} - 홀 수정 실패")
    void updateHall_Failure() throws Exception {
        // given
        testRequest.setId(1L);
        given(hallService.updateHall(any(HallRequest.class))).willReturn(false);
    ...
    @Test
    @DisplayName("DELETE /api/hall/{id} - 홀 삭제 성공")
    void deleteHall_Success() throws Exception {
        // given
        given(hallService.deleteHall(anyLong())).willReturn(true);
    ...
    @Test
    @DisplayName("DELETE /api/hall/{id} - 홀 삭제 실패")
    void deleteHall_Failure() throws Exception {
        // given
        given(hallService.deleteHall(anyLong())).willReturn(false);
